...
if has("autocmd")
    ...
    augroup python_files "{{{
        ...
        " Python runners
        autocmd filetype python noremap <buffer> <F5> :w<CR>:!/usr/bin/env python %<CR>
        autocmd filetype python inoremap <buffer> <F5> <Esc>:w<CR>:!/usr/bin/env python %<CR>
        autocmd filetype python noremap <buffer> <S-F5> :w<CR>:!/usr/bin/env ipython %<CR>
        autocmd filetype python inoremap <buffer> <S-F5> <Esc>:w<CR>:!/usr/bin/env ipython %<CR>
...
iabbr m@@ vv@vv.mk
iabbr v@@ vojnovski@gmail.com
iabbr ssig --<cr>Viktor Vojnovski<cr>viktor.vojnovski@amadeus.com
